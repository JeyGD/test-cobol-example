...
000200 PROGRAM-ID.    AAAAAAAA.
000300*
000400 ENVIRONMENT DIVISION.
000500 DATA DIVISION.
000600 WORKING-STORAGE SECTION.
000700     COPY MYCOPY011.
...
003300*
003400 UPDATE-DATA.
003500     ADD 10 TO WS-PRICE.
003600     EXEC SQL
003700         UPDATE PRODUCTS
003800         SET PRICE = :WS-PRICE
003900         WHERE PRODUCT_ID = :WS-PRODUCT-ID
004000     END-EXEC.
004100*
